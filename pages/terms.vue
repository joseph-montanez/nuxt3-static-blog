<template>
  <Head>
    ...
    <Meta name="description" content="Its terms..." />
  </Head>
  <NuxtLayout name="default">
    ...
    <div class="container mx-auto px-4">
      <div class="flex flex-col">
        <div class="w-full">
          <h1 class="mt-5 text-3xl font-bold">Terms and Conditions</h1>
          <p class="mt-2">Last updated: December 04, 2022</p>
          <p class="mt-2">Please read these terms and conditions carefully before using Our Service.</p>


          <h1 class="mt-5 text-3xl font-bold">Interpretation and Definitions</h1>
          <h2 class="mt-4 text-2xl font-semibold">Interpretation</h2>
          ...
          <h2 class="mt-4 text-2xl font-semibold">Definitions</h2>
          ...
          <ul>
            ...
            <li>
              <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                or &quot;Our&quot; in this Agreement) refers to Drawing Tablet Comparison.</p>
            </li>
            <li>
            ...
            <li>
              <p><strong>Website</strong> refers to Drawing Tablet Comparison, accessible from <a
                  href="https://montanez.dev/" rel="external nofollow noopener" target="_blank">https://montanez.dev/</a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>By email: sutabi@gmail.com</li>
          </ul>
        </div>
      </div>
    </div>
