<template>
  <Head>
    ...
    <Meta name="description" content="Its a privacy policy..." />
  </Head>
            ...
            <ul>
              ...
              <li>
                <p><strong>Website</strong> refers to Drawing Tablet Comparison, accessible from <a
                    href="https://montanez.dev" rel="external nofollow noopener"
                    target="_blank">https://montanez.dev</a></p>
              </li>
              <li>
